...
import designpatterns.headfirstdp.chap4_factory.abstractfactory.ingredients.belgian.BelgianCheese;
import designpatterns.headfirstdp.chap4_factory.abstractfactory.ingredients.belgian.BelgianDough;
import designpatterns.headfirstdp.chap4_factory.abstractfactory.ingredients.belgian.BelgianSauce;
...
public class BelgianPizzaIngredientFactory implements PizzaIngredientsFactory {
	@Override
	public Dough createDough() {
		return new BelgianDough();
	}
	
	@Override
	public Sauce createSauce() {
		return new BelgianSauce();
	}
	
	@Override
	public Cheese createCheese() {
		return new BelgianCheese();
	}
